...
ProfileRouter.patch('/editWifiUser', IpMiddleware('edit wifi user'), Usercontroller.edit_wifi_user, mqttController.publishdata);
ProfileRouter.patch('/editWifiPass', IpMiddleware('edit wifi pass'), Usercontroller.edit_pass_user, mqttController.publishdata);
